class PromptEngineeringFormatter {
    ...
    createViewContainers() {
        // Find the existing view-prompt-eng container
        const parentContainer = document.querySelector('.view-prompt-eng');
        
        if (!parentContainer) {
            console.error('Parent container .view-prompt-eng not found!');
            return;
        }
        
        // Create view containers for each method inside the view-prompt-eng div
        this.methods.forEach((method, index) => {
            ...
            if (!existingContainer) {
                ...
                // Add it to the view-prompt-eng parent
    ...
    removeOldContainers() {
        // Remove all existing containers from within view-prompt-eng
        const parentContainer = document.querySelector('.view-prompt-eng');
        if (parentContainer) {
            const existingContainers = parentContainer.querySelectorAll('[class*="view-prompt-engineering-method-"]');
